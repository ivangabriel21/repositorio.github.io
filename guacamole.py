...
system("apt install tomcat9 tomcat9-admin tomcat9-common tomcat9-user")
...
input("Ahora configuras el usuario cambia admin por el usuario que quieras, y En Contraseña MD5 Pon esto: ", hashed_password)
print("sleep 2s")
